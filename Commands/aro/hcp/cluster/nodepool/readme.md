...
Manage Azure Red Hat OpenShift Hosted Control Plane Node Pools
...
: Delete an Azure Red Hat OpenShift Hosted Control Plane Node Pool

- [list](/Commands/aro/hcp/cluster/nodepool/_list.md)
: List Azure Red Hat OpenShift Hosted Control Plane Node Pool by Cluster

- [show](/Commands/aro/hcp/cluster/nodepool/_show.md)
: Get an Azure Red Hat OpenShift Hosted Control Plane Node Pool

- [update](/Commands/aro/hcp/cluster/nodepool/_update.md)
: Update an Azure Red Hat OpenShift Hosted Control Plane Node Pool
